...
# variable values can change but the variable name will stay the same.

userName = 'Ian'
emailAdress = 'ian@gmial.com'
profilePicture = 'profile.png'
phoneNumber = 21239384

# the input function is used for passing in data. 
# whatever we type into the input will take on the value of the
# variable, which in this case is name
